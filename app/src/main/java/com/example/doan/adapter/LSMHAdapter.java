...
public class LSMHAdapter extends RecyclerView.Adapter<LSMHAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(@NonNull ItemHolder holder, int position) {
        ...
        holder.txtTT_title.setText("Tổng Tiền : " + format.format(Double.valueOf(order.getAmount())) + " $");
        holder.txtTT_content.setText("Tổng Tiền : " + format.format(Double.valueOf(order.getAmount()))+ " $");
