...
import com.example.doan.AdminActivity;
...
public class SanPhamAdapter extends RecyclerView.Adapter<SanPhamAdapter.ItemViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        if(sp.getPromotion() > 0){
            holder.txtGiaSP_title.setText("GIÁ : " + format.format(Double.valueOf(sp.getPrice()))+ "$" + " (-" + sp.getPromotion() + "%) " + "(SL:" + sp.getQuantity() + ")");
        }else {
            holder.txtGiaSP_title.setText("GIÁ : " + format.format(Double.valueOf(sp.getPrice()))+ "$" + " (SL:" + sp.getQuantity() + ")");
        }
